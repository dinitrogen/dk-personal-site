    ...
    <section className="md:container mx-auto">
      ...
      <div>
        <MotionDiv delay={0.4}>
          <p className="text-xl font-normal w-2/3 mx-auto my-8">
            Here are some examples of my work, including professional projects I have contributed to and personal projects, leveraging the
            various tools and technologies I have become proficient with. Hover
            over or tap on each video for more details and links to the application and source code.
          </p>
        </MotionDiv>
      </div>
      ...
      {projects.map((project) => {
        ...
        return(
          ...
          <div className={`flex flex-col ${toggle.current ? "lg:flex-row" : "lg:flex-row-reverse"} justify-center gap-12`}>
